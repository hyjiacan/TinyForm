...
>默认的选择器是*input[name]:not([type=button][type=submit][type=reset]), select[name], textarea[name]*，这项是写在文件*src/tinyform.core.js*里面的全局变量*CONTROL_SELECTOR*中。当然，也可以通过参数*selector*来自定义。
